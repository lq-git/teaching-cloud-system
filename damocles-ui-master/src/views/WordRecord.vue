<template>
  <el-form :inline="true" label-position="left" ref="queryForm" :model="queryModel" class="queryForm">
    ...
    <el-form-item label="中文" prop="chinese">
      <el-input v-model="queryModel.chinese" placeholder="请输入中文"></el-input>
    </el-form-item>
    <el-form-item label="作者" prop="author">
      <el-input v-model="queryModel.author" placeholder="请输入作者"></el-input>
    </el-form-item>
    <el-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const queryModel: Word = reactive({});
    const query = (size = 16) => {
      request("/word/record/query", { size: size, ...queryModel }).then(
        (response) => {
